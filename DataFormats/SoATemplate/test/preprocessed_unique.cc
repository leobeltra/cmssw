...
struct SimpleLayoutTemplate {
  using self_type = SimpleLayoutTemplate;
  ...
  struct Metadata {
    ...
    inline __attribute__((always_inline)) byte_size_type alignment() const { return SimpleLayoutTemplate::alignment; }
    ...
    inline __attribute__((always_inline)) SimpleLayoutTemplate cloneToNewAddress(std::byte* _soa_impl_addr) const {
      return SimpleLayoutTemplate(_soa_impl_addr, parent_.elements_);
    }
  ...
  private:
    inline __attribute__((always_inline)) Metadata(const SimpleLayoutTemplate& _soa_impl_parent)
        : parent_(_soa_impl_parent) {}
    const SimpleLayoutTemplate& parent_;
    using ParentClass = SimpleLayoutTemplate;
  };
  friend Metadata;
  ...
  struct ConstViewTemplateFreeParams {
    ...
    using SimpleLayoutTemplate_parametrized = SimpleLayoutTemplate<VIEW_ALIGNMENT, VIEW_ALIGNMENT_ENFORCEMENT>;
    using size_type = cms::soa::size_type;
    using byte_size_type = cms::soa::byte_size_type;
    using AlignmentEnforcement = cms::soa::AlignmentEnforcement;
    ...
    struct Metadata {
      ...
      inline __attribute__((always_inline)) size_type size() const { return parent_.elements_; }
      using TypeOf_instance_SimpleLayoutTemplate = SimpleLayoutTemplate_parametrized;
      using TypeOf_x = typename TypeOf_instance_SimpleLayoutTemplate::Metadata::TypeOf_x;
      using ParametersTypeOf_x = typename TypeOf_instance_SimpleLayoutTemplate::Metadata::ParametersTypeOf_x;
      constexpr static cms::soa::SoAColumnType ColumnTypeOf_x =
          TypeOf_instance_SimpleLayoutTemplate::Metadata::ColumnTypeOf_x;
      ...
      using TypeOf_y = typename TypeOf_instance_SimpleLayoutTemplate::Metadata::TypeOf_y;
      using ParametersTypeOf_y = typename TypeOf_instance_SimpleLayoutTemplate::Metadata::ParametersTypeOf_y;
      constexpr static cms::soa::SoAColumnType ColumnTypeOf_y =
          TypeOf_instance_SimpleLayoutTemplate::Metadata::ColumnTypeOf_y;
      ...
      using TypeOf_z = typename TypeOf_instance_SimpleLayoutTemplate::Metadata::TypeOf_z;
      using ParametersTypeOf_z = typename TypeOf_instance_SimpleLayoutTemplate::Metadata::ParametersTypeOf_z;
      constexpr static cms::soa::SoAColumnType ColumnTypeOf_z =
          TypeOf_instance_SimpleLayoutTemplate::Metadata::ColumnTypeOf_z;
      ...
      using TypeOf_t = typename TypeOf_instance_SimpleLayoutTemplate::Metadata::TypeOf_t;
      using ParametersTypeOf_t = typename TypeOf_instance_SimpleLayoutTemplate::Metadata::ParametersTypeOf_t;
      constexpr static cms::soa::SoAColumnType ColumnTypeOf_t =
          TypeOf_instance_SimpleLayoutTemplate::Metadata::ColumnTypeOf_t;
    ...
    ConstViewTemplateFreeParams(const SimpleLayoutTemplate_parametrized& instance_SimpleLayoutTemplate)
        : elements_([&]() -> size_type {
            bool set = false;
            size_type ret = 0;
            if (set) {
              if (ret != instance_SimpleLayoutTemplate.metadata().size())
                throw std::runtime_error("In constructor by layout: different sizes from layouts.");
            } else {
              ret = instance_SimpleLayoutTemplate.metadata().size();
              set = true;
            }
            return ret;
          }()),
          xParameters_([&]() -> auto {
            auto params = instance_SimpleLayoutTemplate.metadata().parametersOf_x();
          ...
          yParameters_([&]() -> auto {
            auto params = instance_SimpleLayoutTemplate.metadata().parametersOf_y();
            if constexpr (alignmentEnforcement == AlignmentEnforcement::enforced)
              if (reinterpret_cast<intptr_t>(params.addr_) % alignment)
                throw std::runtime_error(
                    "In constructor by layout: misaligned column: "
          ...
          zParameters_([&]() -> auto {
            auto params = instance_SimpleLayoutTemplate.metadata().parametersOf_z();
            if constexpr (alignmentEnforcement == AlignmentEnforcement::enforced)
              if (reinterpret_cast<intptr_t>(params.addr_) % alignment)
                throw std::runtime_error(
                    "In constructor by layout: misaligned column: "
          ...
          tParameters_([&]() -> auto {
            auto params = instance_SimpleLayoutTemplate.metadata().parametersOf_t();
            if constexpr (alignmentEnforcement == AlignmentEnforcement::enforced)
              if (reinterpret_cast<intptr_t>(params.addr_) % alignment)
                throw std::runtime_error(
                    "In constructor by layout: misaligned column: "
  ...
  struct ViewTemplateFreeParams
    ...
    ViewTemplateFreeParams(SimpleLayoutTemplate_parametrized& instance_SimpleLayoutTemplate)
        : base_type{instance_SimpleLayoutTemplate} {}
    ...
    struct element {
      ...
      inline __attribute__((always_inline)) constexpr element& operator=(
          const typename SimpleLayoutTemplate_parametrized::Metadata::value_element _soa_impl_value) {
        x() = _soa_impl_value.x;
        y() = _soa_impl_value.y;
        z() = _soa_impl_value.z;
        t() = _soa_impl_value.t;
  ...
  SimpleLayoutTemplate()
      : mem_(nullptr),
        ...
        t_(nullptr),
        BOOST_PP_SEQ_ENUM_0 {}
  SimpleLayoutTemplate(std::byte* mem, size_type elements) : mem_(mem), elements_(elements), byteSize_(0) {
    organizeColumnsFromBuffer();
  }
  SimpleLayoutTemplate(SimpleLayoutTemplate const& _soa_impl_other)
      : mem_(_soa_impl_other.mem_),
        ...
        BOOST_PP_SEQ_ENUM_0 {}
  SimpleLayoutTemplate& operator=(SimpleLayoutTemplate const& _soa_impl_other) {
    mem_ = _soa_impl_other.mem_;
    elements_ = _soa_impl_other.elements_;
    byteSize_ = _soa_impl_other.byteSize_;
    x_ = _soa_impl_other.x_;
...
private:
  ...
  static constexpr std::pair<size_type, size_type> computeMethodsNumber() {
    ...
    _COUNT_SOA_METHODS_IMPL BOOST_PP_IIF_BOOST_PP_BOOL_BOOST_PP_INC_BOOST_PP_REM BOOST_PP_TUPLE_TO_ARRAY_0()(
        BOOST_PP_ARRAY_DATA, BOOST_PP_ARRAY_TO_TUPLE_EMPTY)((
        BOOST_PP_INC_BOOST_PP_REM BOOST_PP_TUPLE_TO_ARRAY_0(),
        (BOOST_PP_IIF_BOOST_PP_BOOL_BOOST_PP_REM BOOST_PP_TUPLE_TO_ARRAY_0()(BOOST_PP_ARRAY_DETAIL_GET_DATA_ANY,
                                                                             BOOST_PP_ARRAY_DETAIL_GET_DATA_NONE)(
            BOOST_PP_REM BOOST_PP_TUPLE_TO_ARRAY_0(), )
             BOOST_PP_IIF_BOOST_PP_BOOL_BOOST_PP_REM BOOST_PP_TUPLE_TO_ARRAY_0()(BOOST_PP_COMMA, BOOST_PP_EMPTY)()
                 _soa_methods_count)))_COUNT_SOA_CONST_METHODS_IMPL BOOST_PP_IIF_BOOST_PP_BOOL_BOOST_PP_INC_BOOST_PP_REM
        BOOST_PP_TUPLE_TO_ARRAY_0()(BOOST_PP_ARRAY_DATA, BOOST_PP_ARRAY_TO_TUPLE_EMPTY)(
            (BOOST_PP_INC_BOOST_PP_REM BOOST_PP_TUPLE_TO_ARRAY_0(),
             (BOOST_PP_IIF_BOOST_PP_BOOL_BOOST_PP_REM BOOST_PP_TUPLE_TO_ARRAY_0()(BOOST_PP_ARRAY_DETAIL_GET_DATA_ANY,
                                                                                  BOOST_PP_ARRAY_DETAIL_GET_DATA_NONE)(
                 BOOST_PP_REM BOOST_PP_TUPLE_TO_ARRAY_0(), )
                  BOOST_PP_IIF_BOOST_PP_BOOL_BOOST_PP_REM BOOST_PP_TUPLE_TO_ARRAY_0()(BOOST_PP_COMMA, BOOST_PP_EMPTY)()
                      _soa_const_methods_count))) return {
          _soa_methods_count,
          _soa_const_methods_count
        };
  }
...
namespace {
  Catch::AutoReg autoRegistrar1(Catch::makeTestInvoker(&____C_A_T_C_H____T_E_S_T____0),
                                ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(20)),
                                Catch::StringRef(),
...
#pragma clang diagnostic ignored "-Wunused-variable"
  if (Catch::Section const& catch_internal_Section2 = Catch::SectionInfo(
          ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(31)), "Row wide copies, row"))
#pragma clang diagnostic pop
  {
    ...
    for (SimpleLayout::View::size_type i = 0; i < slv.metadata().size(); ++i) {
      ...
      auto slcvi = slcv[i];
      do {
        (void)__builtin_constant_p(slvi.x() == x);
        Catch::AssertionHandler catchAssertionHandler(
            "REQUIRE"_catch_sr,
            ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(54)),
            "slvi.x() == x",
            Catch::ResultDisposition::Normal);
        try {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wparentheses"
          catchAssertionHandler.handleExpr(Catch::Decomposer() <= slvi.x() == x);
#pragma clang diagnostic pop
        } catch (...) {
          catchAssertionHandler.handleUnexpectedInflightException();
        }
        catchAssertionHandler.complete();
      } while ((void)0, (false) && static_cast<bool>(!!(slvi.x() == x)));
      do {
        (void)__builtin_constant_p(slvi.y() == y);
        Catch::AssertionHandler catchAssertionHandler(
            "REQUIRE"_catch_sr,
            ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(55)),
            "slvi.y() == y",
            Catch::ResultDisposition::Normal);
        try {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wparentheses"
          catchAssertionHandler.handleExpr(Catch::Decomposer() <= slvi.y() == y);
#pragma clang diagnostic pop
        } catch (...) {
          catchAssertionHandler.handleUnexpectedInflightException();
        }
        catchAssertionHandler.complete();
      } while ((void)0, (false) && static_cast<bool>(!!(slvi.y() == y)));
      do {
        (void)__builtin_constant_p(slvi.z() == z);
        Catch::AssertionHandler catchAssertionHandler(
            "REQUIRE"_catch_sr,
            ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(56)),
            "slvi.z() == z",
            Catch::ResultDisposition::Normal);
        try {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wparentheses"
          catchAssertionHandler.handleExpr(Catch::Decomposer() <= slvi.z() == z);
#pragma clang diagnostic pop
        } catch (...) {
          catchAssertionHandler.handleUnexpectedInflightException();
        }
        catchAssertionHandler.complete();
      } while ((void)0, (false) && static_cast<bool>(!!(slvi.z() == z)));
      do {
        (void)__builtin_constant_p(slvi.t() == t);
        Catch::AssertionHandler catchAssertionHandler(
            "REQUIRE"_catch_sr,
            ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(57)),
            "slvi.t() == t",
            Catch::ResultDisposition::Normal);
        try {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wparentheses"
          catchAssertionHandler.handleExpr(Catch::Decomposer() <= slvi.t() == t);
#pragma clang diagnostic pop
        } catch (...) {
          catchAssertionHandler.handleUnexpectedInflightException();
        }
        catchAssertionHandler.complete();
      } while ((void)0, (false) && static_cast<bool>(!!(slvi.t() == t)));
      do {
        (void)__builtin_constant_p(slcvi.x() == x);
        Catch::AssertionHandler catchAssertionHandler(
            "REQUIRE"_catch_sr,
            ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(58)),
            "slcvi.x() == x",
            Catch::ResultDisposition::Normal);
        try {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wparentheses"
          catchAssertionHandler.handleExpr(Catch::Decomposer() <= slcvi.x() == x);
#pragma clang diagnostic pop
        } catch (...) {
          catchAssertionHandler.handleUnexpectedInflightException();
        }
        catchAssertionHandler.complete();
      } while ((void)0, (false) && static_cast<bool>(!!(slcvi.x() == x)));
      do {
        (void)__builtin_constant_p(slcvi.y() == y);
        Catch::AssertionHandler catchAssertionHandler(
            "REQUIRE"_catch_sr,
            ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(59)),
            "slcvi.y() == y",
            Catch::ResultDisposition::Normal);
        try {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wparentheses"
          catchAssertionHandler.handleExpr(Catch::Decomposer() <= slcvi.y() == y);
#pragma clang diagnostic pop
        } catch (...) {
          catchAssertionHandler.handleUnexpectedInflightException();
        }
        catchAssertionHandler.complete();
      } while ((void)0, (false) && static_cast<bool>(!!(slcvi.y() == y)));
      do {
        (void)__builtin_constant_p(slcvi.z() == z);
        Catch::AssertionHandler catchAssertionHandler(
            "REQUIRE"_catch_sr,
            ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(60)),
            "slcvi.z() == z",
            Catch::ResultDisposition::Normal);
        try {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wparentheses"
          catchAssertionHandler.handleExpr(Catch::Decomposer() <= slcvi.z() == z);
#pragma clang diagnostic pop
        } catch (...) {
          catchAssertionHandler.handleUnexpectedInflightException();
        }
        catchAssertionHandler.complete();
      } while ((void)0, (false) && static_cast<bool>(!!(slcvi.z() == z)));
      do {
        (void)__builtin_constant_p(slcvi.t() == t);
        Catch::AssertionHandler catchAssertionHandler(
            "REQUIRE"_catch_sr,
            ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(61)),
            "slcvi.t() == t",
            Catch::ResultDisposition::Normal);
        try {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wparentheses"
          catchAssertionHandler.handleExpr(Catch::Decomposer() <= slcvi.t() == t);
#pragma clang diagnostic pop
        } catch (...) {
          catchAssertionHandler.handleUnexpectedInflightException();
        }
        catchAssertionHandler.complete();
      } while ((void)0, (false) && static_cast<bool>(!!(slcvi.t() == t)));
      auto tx = x;
      x += y;
      y += z;
      z += t;
...
#pragma clang diagnostic ignored "-Wunused-variable"
  if (Catch::Section const& catch_internal_Section3 =
          Catch::SectionInfo(::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(70)),
                             "Row initializer, const view access, restrict disabling"))
#pragma clang diagnostic pop
  {
    ...
    for (SimpleLayout::View::size_type i = 0; i < slv.metadata().size(); ++i) {
      ...
      do {
        ...
        Catch::AssertionHandler catchAssertionHandler(
            "REQUIRE"_catch_sr,
            ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(95)),
            "slvi.x() == x",
            Catch::ResultDisposition::Normal);
        try {
#pragma clang diagnostic push
...
#pragma clang diagnostic pop
      ...
      do {
        ...
        Catch::AssertionHandler catchAssertionHandler(
            "REQUIRE"_catch_sr,
            ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(96)),
            "slvi.y() == y",
            Catch::ResultDisposition::Normal);
        try {
#pragma clang diagnostic push
...
#pragma clang diagnostic pop
      ...
      do {
        ...
        Catch::AssertionHandler catchAssertionHandler(
            "REQUIRE"_catch_sr,
            ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(97)),
            "slvi.z() == z",
            Catch::ResultDisposition::Normal);
        try {
#pragma clang diagnostic push
...
#pragma clang diagnostic pop
      ...
      do {
        ...
        Catch::AssertionHandler catchAssertionHandler(
            "REQUIRE"_catch_sr,
            ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(98)),
            "slvi.t() == t",
            Catch::ResultDisposition::Normal);
        try {
#pragma clang diagnostic push
...
#pragma clang diagnostic pop
      ...
      do {
        ...
        Catch::AssertionHandler catchAssertionHandler(
            "REQUIRE"_catch_sr,
            ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(99)),
            "slcvi.x() == x",
            Catch::ResultDisposition::Normal);
        try {
#pragma clang diagnostic push
...
#pragma clang diagnostic pop
      ...
      do {
        ...
        Catch::AssertionHandler catchAssertionHandler(
            "REQUIRE"_catch_sr,
            ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(100)),
            "slcvi.y() == y",
            Catch::ResultDisposition::Normal);
        try {
#pragma clang diagnostic push
...
#pragma clang diagnostic pop
      ...
      do {
        ...
        Catch::AssertionHandler catchAssertionHandler(
            "REQUIRE"_catch_sr,
            ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(101)),
            "slcvi.z() == z",
            Catch::ResultDisposition::Normal);
        try {
#pragma clang diagnostic push
...
#pragma clang diagnostic pop
      ...
      do {
        ...
        Catch::AssertionHandler catchAssertionHandler(
            "REQUIRE"_catch_sr,
            ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(102)),
            "slcvi.t() == t",
            Catch::ResultDisposition::Normal);
        try {
#pragma clang diagnostic push
...
#pragma clang diagnostic ignored "-Wunused-variable"
  if (Catch::Section const& catch_internal_Section4 = Catch::SectionInfo(
          ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(111)), "Range checking View"))
#pragma clang diagnostic pop
  {
    ...
    do {
      Catch::AssertionHandler catchAssertionHandler(
          "REQUIRE_THROWS_AS"_catch_sr,
          ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(118)),
          "slv[underflow]"
          ", "
          "std::out_of_range",
          Catch::ResultDisposition::Normal);
      if (catchAssertionHandler.allowThrows())
        try {
          static_cast<void>(slv[underflow]);
    ...
    do {
      Catch::AssertionHandler catchAssertionHandler(
          "REQUIRE_THROWS_AS"_catch_sr,
          ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(119)),
          "slv[overflow]"
          ", "
          "std::out_of_range",
          Catch::ResultDisposition::Normal);
    ...
    do {
      Catch::AssertionHandler catchAssertionHandler(
          "REQUIRE_THROWS_AS"_catch_sr,
          ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(121)),
          "slv.x(underflow)"
          ", "
          "std::out_of_range",
          Catch::ResultDisposition::Normal);
      if (catchAssertionHandler.allowThrows())
        try {
          static_cast<void>(slv.x(underflow));
          catchAssertionHandler.handleUnexpectedExceptionNotThrown();
        } catch (std::out_of_range const&) {
          catchAssertionHandler.handleExceptionThrownAsExpected();
        } catch (...) {
    ...
    do {
      Catch::AssertionHandler catchAssertionHandler(
          "REQUIRE_THROWS_AS"_catch_sr,
          ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(122)),
          "slv.x(overflow)"
          ", "
          "std::out_of_range",
          Catch::ResultDisposition::Normal);
      if (catchAssertionHandler.allowThrows())
        try {
          static_cast<void>(slv.x(overflow));
          catchAssertionHandler.handleUnexpectedExceptionNotThrown();
        } catch (std::out_of_range const&) {
          catchAssertionHandler.handleExceptionThrownAsExpected();
        } catch (...) {
...
#pragma clang diagnostic ignored "-Wunused-variable"
  if (Catch::Section const& catch_internal_Section5 = Catch::SectionInfo(
          ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(125)), "Range checking ConstView"))
#pragma clang diagnostic pop
  {
    using ConstView =
    ...
    do {
      Catch::AssertionHandler catchAssertionHandler(
          "REQUIRE_THROWS_AS"_catch_sr,
          ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(133)),
          "slcv[underflow]"
          ", "
          "std::out_of_range",
          Catch::ResultDisposition::Normal);
      if (catchAssertionHandler.allowThrows())
        try {
          static_cast<void>(slcv[underflow]);
          catchAssertionHandler.handleUnexpectedExceptionNotThrown();
        } catch (std::out_of_range const&) {
          catchAssertionHandler.handleExceptionThrownAsExpected();
        } catch (...) {
    ...
    do {
      Catch::AssertionHandler catchAssertionHandler(
          "REQUIRE_THROWS_AS"_catch_sr,
          ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(134)),
          "slcv[overflow]"
          ", "
          "std::out_of_range",
          Catch::ResultDisposition::Normal);
      if (catchAssertionHandler.allowThrows())
        try {
          static_cast<void>(slcv[overflow]);
          catchAssertionHandler.handleUnexpectedExceptionNotThrown();
        } catch (std::out_of_range const&) {
          catchAssertionHandler.handleExceptionThrownAsExpected();
        } catch (...) {
    ...
    do {
      Catch::AssertionHandler catchAssertionHandler(
          "REQUIRE_THROWS_AS"_catch_sr,
          ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(136)),
          "slcv.x(underflow)"
          ", "
          "std::out_of_range",
          Catch::ResultDisposition::Normal);
      if (catchAssertionHandler.allowThrows())
        try {
          static_cast<void>(slcv.x(underflow));
          catchAssertionHandler.handleUnexpectedExceptionNotThrown();
        } catch (std::out_of_range const&) {
          catchAssertionHandler.handleExceptionThrownAsExpected();
        } catch (...) {
    ...
    do {
      Catch::AssertionHandler catchAssertionHandler(
          "REQUIRE_THROWS_AS"_catch_sr,
          ::Catch::SourceLineInfo("SoAUnitTests.cc", static_cast<std::size_t>(137)),
          "slcv.x(overflow)"
          ", "
          "std::out_of_range",
          Catch::ResultDisposition::Normal);
      if (catchAssertionHandler.allowThrows())
        try {
          static_cast<void>(slcv.x(overflow));
          catchAssertionHandler.handleUnexpectedExceptionNotThrown();
        } catch (std::out_of_range const&) {
          catchAssertionHandler.handleExceptionThrownAsExpected();
        } catch (...) {
