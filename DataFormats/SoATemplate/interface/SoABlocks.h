...
#define _COUNT_SOA_BLOCKS_METHODS_IMPL(VALUE_TYPE, NAME, LAYOUT_NAME, DATA) \
  BOOST_PP_IF(BOOST_PP_EQUAL(VALUE_TYPE, _VALUE_TYPE_VIEW_METHOD), DATA++;, BOOST_PP_EMPTY())

#define _COUNT_SOA_BLOCKS_METHODS(R, DATA, NAME) \
  BOOST_PP_EXPAND(_COUNT_SOA_BLOCKS_METHODS_IMPL BOOST_PP_TUPLE_PUSH_BACK(NAME, DATA))

#define _COUNT_SOA_BLOCKS_CONST_METHODS_IMPL(VALUE_TYPE, NAME, LAYOUT_NAME, DATA) \
  BOOST_PP_IF(BOOST_PP_EQUAL(VALUE_TYPE, _VALUE_TYPE_CONST_VIEW_METHOD), DATA++;, BOOST_PP_EMPTY())

#define _COUNT_SOA_BLOCKS_CONST_METHODS(R, DATA, NAME) \
  BOOST_PP_EXPAND(_COUNT_SOA_BLOCKS_CONST_METHODS_IMPL BOOST_PP_TUPLE_PUSH_BACK(NAME, DATA))
  ...
  struct CLASS {                                                                                                       \
    ...
    struct ConstView {                                                                                                 \
      ...
      _ITERATE_ON_ALL(_DECLARE_ACCESSORS_CONST_VIEW_BLOCKS, ~, __VA_ARGS__)                                            \
                                                                                                                       \
      /* Generate user defined methods for the ConstView */                                                            \
    ...
    struct View : ConstView {                                                                                          \
      ...
      _ITERATE_ON_ALL(_DECLARE_ACCESSORS_VIEW_BLOCKS, ~, __VA_ARGS__)                                                  \
                                                                                                                       \
      /* Generate user defined methods for the View */                                                                 \
    ...
    private:                                                                                                           \
      ...
      static constexpr std::pair<size_type, size_type> computeMethodsNumber() {                                        \
        ...
        size_type _soa_const_methods_count = 0;                                                                        \
                                                                                                                       \
        _ITERATE_ON_ALL(_COUNT_SOA_BLOCKS_METHODS, _soa_methods_count, __VA_ARGS__)                                    \
        _ITERATE_ON_ALL(_COUNT_SOA_BLOCKS_CONST_METHODS, _soa_const_methods_count, __VA_ARGS__)                        \
                                                                                                                       \
