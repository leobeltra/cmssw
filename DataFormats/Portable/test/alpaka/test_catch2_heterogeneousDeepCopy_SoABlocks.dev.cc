...
TEST_CASE("Heterogeneous Deep Copy SoABlocks") {
  ...
  for (auto const& device : devices) {
    ...
    PortableCollection<SoAPosition, Device> positionCollection(elemPos, queue);
    PortableCollection<SoAPCA, Device> pcaCollection(elemPCA, queue);
    ...
    SECTION("Heterogeneous deep copy of the SoABlocks View") {
      ...
      PortableCollection<SoAGenericBlocks, Device> genericCollection(queue, elemPos, elemPCA);
      genericCollection.deepCopy(genericBlocksView, queue);
