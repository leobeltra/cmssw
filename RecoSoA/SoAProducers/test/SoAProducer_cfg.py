...
# process.soaproducer3 = cms.EDProducer("SoAProducer3", soaInput = cms.InputTag("soaproducer2", "SoAProduct2"))

# Add to process path
process.p = cms.Path(process.soaproducer * process.soaproducer2
                     )